...
% Conjunto de números
% usar SOLO en en modo matemático
...
% Espacio en blanco (1px)
% Modo de uso: \blank
\newcommand{\blank}{\hspace{1px}}
...
\input{Resultados Útiles/identidades}
\input{Resultados Útiles/integrales}
\input{Resultados Útiles/var_compleja} % lo puse aquí, no se si querrás cambiarlo o algo
\input{Resultados Útiles/Coordenadas}
\input{Resultados Útiles/Teoremas}
...
% CVV
\input{CVV/Topología/bolas}
\input{CVV/Diferencial/Cálculo Diferencial}

% CAA
\input{CAA/Cálculo Vectorial/Cálculo Vectorial}
\input{CAA/Cálculo Vectorial/Demos}
\input{CAA/Cálculo Vectorial/Problemas}
\input{CAA/Cálculo Vectorial/Soluciones}
\input{CAA/Variable Compleja/Variable Compleja}
%\input{CAA/Variable Compleja/Demos}
%\input{CAA/Variable Compleja/Problemas}
%\input{CAA/Variable Compleja/Soluciones}
