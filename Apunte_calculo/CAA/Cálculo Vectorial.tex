\section{Cálculo Avanzado y Aplicaciones}
...
\[\Vec{F} = \nabla P\] % Según el apunte de cálculo es menos el gradiente, sobre un espacio conexo

% Conca lo pone sin menos, creo que las dos son validas, al final es casi lo mismo. Pondré la que se use más e indicaré que la otra también se usa
