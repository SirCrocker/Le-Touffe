...
\[\implies \devtermo{p}{G}{T} = -S \quad \land \quad \devtermo{T}{G}{p} = V\]
...
\item Haciendo uso de la primera igualdad y en el punto anterior y de la \txtsi{relación cíclica}{(\ref{sub:relacion_ciclica})} se puede despejar 
...
% Siento que se podría mejorar la visualización
\begin{equation}
    \begin{split}
...
% Lo de abajo está en el volumen 5 de Barra, no se si nos será útil pero lo escribí en caso de que lo sea y así es descomentarlo simplemente.

%\subsubsection{Potencial de Landau o gran potencial}

%Sea $J = J(V,T,\mu) = E - TS - \mu N$ un potencial termodinámico ($dJ = -pdV - SdT - Nd\mu$)
